...
using VecTiles.DataSources.MbTiles.Tables;

namespace VecTiles.DataSources.MbTiles;
...
public class MbTilesTileDataSource : ITileDataSource
{
    ...
    private readonly Dictionary<int, Common.Primitives.TileRange>? _tileRange;
    ...
    private static Dictionary<int, Common.Primitives.TileRange> ReadTileRangeForEachLevelFromTilesTable(SQLiteConnection connection, IEnumerable<int> zoomLevels)
    {
        var tableName = "tiles";
        var tileRange = new Dictionary<int, Common.Primitives.TileRange>();
